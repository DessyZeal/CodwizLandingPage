export default function Impacts() {
    return (
        <section id="impacts" className="flex flex-col items-center justify-center px-3 py-10 pt-28 lg:py-0 gap-8 pb-20 md:pb-20 lg:pb-20">
            ...
            <p className="text-gray-500 font-normal text-2xl max-w-4xl text-center">Transforming lives through technology, one child at a time.</p>
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 py-10 text-center text-black font-bold text-2xl">
                <div className="bg-white p-6 flex flex-col items-center justify-center rounded-lg shadow-md text-center hover:shadow-xl transition-shadow duration-300">
                    <h2 className="bg-text-gradient bg-clip-text text-transparent text-4xl lg:text-6xl lg:px-10">500+</h2>
                    <p className="text-gray-500 text-sm font-medium ">Kids empowered</p>
                </div>
                <div className="bg-white p-6 flex flex-col items-center justify-center rounded-lg rounde-sm shadow-md text-center hover:shadow-xl transition-shadow duration-300">
                    <h2 className="bg-text-gradient bg-clip-text text-transparent text-4xl lg:text-6xl lg:px-10">50+</h2>
                    <p className="text-gray-500 text-sm font-medium">Community Outreaches</p>
                </div>
                <div className="bg-white p-6 flex flex-col items-center justify-center rounded-lg shadow-md text-center hover:shadow-xl transition-shadow duration-300">
                    <h2 className="bg-text-gradient bg-clip-text text-transparent text-4xl lg:text-6xl lg:px-10">1000+</h2>
                    <p className="text-gray-500 text-sm font-medium">Tech skills learned</p>
                </div>
                <div className="bg-white p-6 flex flex-col items-center justify-center rounded-lg shadow-md text-center hover:shadow-xl transition-shadow duration-300">
                    <h2 className="bg-text-gradient bg-clip-text text-transparent text-4xl lg:text-6xl lg:px-10">25+</h2>
                    <p className="text-gray-500 text-sm font-medium">Schools partnered</p>
                </div>
            </div>
            <div className="max-w-3xl mx-auto text-black text-start bg-white p-10 rounded-lg shadow-md">
